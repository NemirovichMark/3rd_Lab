...
static void lvl1Task6()
{
    ...
    for (int i = 0; i < 5; i++)
    {
        try { array[i] = Math.Pow(Convert.ToDouble(Console.ReadLine()), 2); }
...
static void lvl1Task11()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        try { array2[i] = Convert.ToDouble(Console.ReadLine()); }
        catch { Console.WriteLine("Error"); return; }
...
static void lvl1Task12()
{
    ...
    for (int i = 0; i < 8; i++)
    {
        try { array3[i] = Convert.ToDouble(Console.ReadLine()); }
        catch { Console.WriteLine("Error"); return; }
        if (array3[i] < 0)
        {
...
static void lvl2Task6()
{
    ...
    double P = 0;
    try { P = Convert.ToDouble(Console.ReadLine()); }
    catch { Console.WriteLine("Error"); return; }
    Console.WriteLine("Enter array values");
    for (int i = 0; i < n; i++)
    {
...
static void lvl2Task15()
{
    ...
    for (int i = 0; i < n; i++)
    {
        try { array_A[i] = Convert.ToDouble(Console.ReadLine()); }
        catch { Console.WriteLine("Error"); return; }
    }
    Console.WriteLine("Enter B element");
    for (int i = 0; i < m; i++)
    {
        try { array_B[i] = Convert.ToDouble(Console.ReadLine()); }
        catch { Console.WriteLine("Error"); return; }
    }
...
static void lvl3Task9()
{
    ...
    for (int i = 0; i < n - 1; i++)
    {
        ...
        {
            temp_1++;
            max_neg = Math.Max(max_neg, temp_1);
        }
        else
        {
            temp_1 = 1;
