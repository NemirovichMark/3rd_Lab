    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                if (aaa[i] < 0)
                {
                    Console.WriteLine("есть отрицательное значение!");
                    break;
                }
                else
                {
                    Console.Write("{0:d}", aaa[i]);
                }
            }
            #endregion
            ...
            double l = 0;
            int immin = 0;
            int[] a = new int[6] { 8, 2, 4, 5, 7, 10 }; //29 29/6=4.833333
            double sr = 0;
            for (int i = 0; i < 6; i++)
            {
                sr += a[i];
            ...
            #region L3Task9
            int[] a = new int[11] { 3, 6, 8, 3, 9, 1, 2, 0, 2, 1, 0 };
            int len = 1;
            int maxlen = 0;
            for (int i = 0; i < 10; ++i)
            {
