    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                Console.Write("Output array: ");
                var j = 0;
                for (i = Math.Min(minN, maxN) + 1; i < Math.Max(minN, maxN); i++)
                {
                    if (array[i] < 0)
                    {
                        outArr[j] = array[i];
                ...
                {
                    Console.WriteLine("Element not exists");
                }
            ...
            {
                Console.WriteLine("You don't follow examples...");
            }
        }
    }
}
